"""
Base Django settings for arbitration_art_django project.

Common settings shared across all environments.
For per-environment overrides, see development.py and production.py.
"""
...
env = environ.Env(
    ...
    SERVICE_REQUEST_TIMEOUT_SECONDS=(int, 5),
...
ROOT_URLCONF = "arbitration_art_django.urls"
...
WSGI_APPLICATION = "arbitration_art_django.wsgi.application"
ASGI_APPLICATION = "arbitration_art_django.asgi.application"
